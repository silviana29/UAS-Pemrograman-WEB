...
<head>
    ...
    <link rel="icon" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/door-open-fill.svg" type="image/svg+xml">
...
<body>
    ...
    <header class="py-1 bg-light border-bottom mb-1">
        <div class="container px-5">
            ...
            <h1 style="font-family: 'Arial Black', sans-serif;">ADMIN</h1>
                <p class="lead mb-0">Silakan masuk untuk mengelola konten Anda.</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <h3 class="text-center" style="font-weight: 900 'Arial Black', sans-serif;">Login</h3>
                    </div>
                    <div class="card-body">
