...
<head>
    ...
    <link rel="icon" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/ticket-perforated-fill.svg" type="image/svg+xml">
                            ...
                            <table id="datatablesSimple">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#catedit<?= $no ?>">Edit</a>
                                                ...
                                                <form action="act_category.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-danger" type="submit" name="catedit">Save</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                ...
                                                <form action="act_category.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-danger" type="submit" name="catdelete">Yes</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="act_category.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Back</button>
                                        <button class="btn btn-danger" type="submit" name="catsave">Add</button>
                                    </div>
                                </div>
                            </form>
                        </div>
