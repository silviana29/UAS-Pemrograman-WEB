...
<head>
    ...
    <link rel="icon" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/file-earmark-person.svg" type="image/svg+xml">
                                                    ...
                                                    <form action="act_admin.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-danger" type="submit" name="bedit">Save</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                    ...
                                                    <form action="act_admin.php" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-danger" type="submit" name="bdelete">Yes</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
