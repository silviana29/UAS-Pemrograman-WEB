...
<head>
    ...
    <link rel="icon" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/clipboard2.svg" type="image/svg+xml">
...
<body>
    ...
    <header class="py-1 bg-light border-bottom mb-1">
        <div class="container">
            ...
            <h1 style="font-family: 'Arial Black', sans-serif;">WELCOME</h1>
            <p class="lead mb-0">Tempat Informasi Menjuru Dunia</p>
            </div>
        </div>
    </header>
    <!-- Page content-->
